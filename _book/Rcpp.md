...
add
#> function (x, y, z) 
#> .Call(<pointer: 0x10f394850>, x, y, z)
add(1, 2, 3)
#> [1] 6
```
...
#> 1 sum(x)       1.21µs   1.29µs   605104.        0B     0   
#> 2 sumC(x)      2.81µs   4.91µs   212178.    2.49KB     0   
#> 3 sumR(x)     36.16µs  36.54µs    25859.  187.22KB     2.59
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 pdistR(0.5, y)   4.02ms   4.13ms      224.    7.63MB     91.9
#> 2 pdistC(0.5, y)   1.93ms   1.97ms      495.    7.63MB    245.
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 gibbs_r(100, 10)     4.28ms   4.66ms      198.    4.97MB     20.9
#> 2 gibbs_cpp(100, 10) 241.42µs 264.91µs     3643.     4.1KB     21.8
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 vacc1        1.57ms   1.71ms      577.    7.86KB    26.6 
#> 2 vacc2       54.61µs  62.97µs    13136.  153.14KB    19.4 
#> 3 vacc3       14.16µs   15.4µs    57843.   14.48KB     5.78
```
