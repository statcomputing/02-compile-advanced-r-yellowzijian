...
```r
env_parents(e2b)
#> [[1]]   <env: 0x7fd5ba0e31b0>
#> [[2]] $ <env: global>
env_parents(e2d)
#> [[1]]   <env: 0x7fd5bb972d98>
#> [[2]] $ <env: empty>
```
