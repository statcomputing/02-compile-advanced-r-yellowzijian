...
```r
ref(l1, l2)
#> █ [1:0x7f9af34954a8] <list> 
#> ├─[2:0x7f9af34a39e8] <dbl> 
#> ├─[3:0x7f9af34a3a20] <dbl> 
#> └─[4:0x7f9af34a3a58] <dbl> 
#>  
#> █ [5:0x7f9af70597c8] <list> 
#> ├─[2:0x7f9af34a39e8] 
#> ├─[3:0x7f9af34a3a20] 
#> └─[6:0x7f9af7135398] <dbl>
```
...
#> █ [1:0x7f9af49c0bf8] <chr> 
#> ├─[2:0x7f9af484f1e0] <string: "a"> 
#> ├─[2:0x7f9af484f1e0] 
#> ├─[3:0x7f9af4c9c008] <string: "abc"> 
#> └─[4:0x7f9af317fe40] <string: "d">
```
...
ref(e)
#> █ [1:0x7f9af4d13408] <env> 
#> └─self = [1:0x7f9af4d13408]
```
...
#> Ncells  737038 39.4    1327367 70.9         NA  1327367 70.9
#> Vcells 4771579 36.5   11808041 90.1      16384 11808014 90.1
```
