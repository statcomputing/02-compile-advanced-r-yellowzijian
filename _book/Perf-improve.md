...
#> 1 mean1(x)    198.1µs  198.8µs     4600.
#> 2 mean2(x)     98.3µs   98.5µs     9777.
```
...
#>   expression           min   median `itr/sec`
#>   <bch:expr>      <bch:tm> <bch:tm>     <dbl>
#> 1 mean(x)           2.82µs   3.35µs   228324.
#> 2 mean.default(x)   1.33µs   1.55µs   569005.
```
...
#>   expression              min   median `itr/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl>
#> 1 mean(x)              2.89µs    3.4µs   232035.
#> 2 mean.default(x)      1.39µs   1.61µs   590844.
#> 3 .Internal(mean(x))    350ns    390ns  2400675.
```
...
#>   expression              min   median `itr/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl>
#> 1 mean(x)              22.3µs   22.8µs    40426.
#> 2 mean.default(x)      20.8µs     21µs    46554.
#> 3 .Internal(mean(x))   19.6µs   19.7µs    49578.
```
...
#>   expression         min   median `itr/sec`
#>   <bch:expr>    <bch:tm> <bch:tm>     <dbl>
#> 1 as.data.frame   1.01ms   1.07ms      867.
#> 2 quick_df        7.55µs   8.39µs   106805.
```
...
#>   expression        min   median `itr/sec`
#>   <bch:expr>   <bch:tm> <bch:tm>     <dbl>
#> 1 lookup[x1]      568ns    727ns   850567.
#> 2 lookup[x10]    1.54µs   1.86µs   401675.
#> 3 lookup[x100]   4.04µs   6.08µs   159984.
```
...
#>   expression      min   median `itr/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl>
#> 1 loop10      18.45µs  19.21µs    48053.
#> 2 loop100    603.36µs 611.02µs     1584.
#> 3 vec10        4.69µs   5.05µs   187347.
#> 4 vec100      33.25µs  33.75µs    28542.
```
